...
def predict( request: fastapi_app.schemas.Emission_Prediction_Request ) -> fastapi_app.schemas.Emission_Prediction_Response :
    """
    
    
    :param request: 
    :type request: fastapi_app.schemas.Emission_Prediction_Request
    :return: 
    ...
    _response = fastapi_app.schemas.Emission_Prediction_Response(
...
def batch_predict( request_ls: list[ fastapi_app.schemas.Emission_Prediction_Request ] ) -> list[ int ]:
    """
    
    
    :param request_ls: 
    :type request_ls: list[ fastapi_app.schemas.Emission_Prediction_Request ]
    :return: 
    :rtype: list[ int ]
    """
